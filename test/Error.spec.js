...
describe('Error', function () {
  ...
  describe('IuguError', function () {
    it('Generates specific instance depending on error-type', function () {
      expect(Error.IuguError.generate({ type: 'card_error' })).to.be.instanceOf(
        Error.IuguCardError
      );
      expect(Error.IuguError.generate({ type: 'invalid_request_error' })).to.be.instanceOf(
        Error.IuguInvalidRequestError
      );
